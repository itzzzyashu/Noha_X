...
from CutiepiiRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get('https://www.kuki-api.tk/api/Kuki/nohaxrobot/message='+Message)
